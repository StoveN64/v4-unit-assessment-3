...
class NPC extends Character{
  ...
  dialogue(name, type, location, phrase){
    return `${this.name}: ${this.phrase}`
  }
}
// const chat = new NPC('Tyrell', 'elf', 'bar', 'How are you?')
// console.log(chat)
...
//CODE HERE
var ralph = new NPC(`Ralph`, `human`, `Niceland`, `I'm gonna wreck it!`)
/*
...
class Player extends Character{
  ...
  //   } else{
  //     return message = `${this.name} has been defeated`
  //   }
  }
